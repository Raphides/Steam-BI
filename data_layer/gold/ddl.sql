...
CREATE TABLE DW.FAT_JGO(
    SRK_JGO BIGINT PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
    NME_JGO VARCHAR(100) VNOT NULL,
    ...
    SRK_OFR BIGINT NOT NULL REFERENCES DW.DIM_OFR,
    SRK_DEV BIGINT NOT NULL REFERENCES DW.DIM_DEV,
    SRK_PBS BIGINT NOT NULL REFERENCES DW.DIM_PBS,
    SRK_CAT BIGINT NOT NULL REFERENCES DW.DIM_CAT,
    SRK_GEN BIGINT NOT NULL REFERENCES DW.DIM_GEN,
    SRK_TAG BIGINT NOT NULL REFERENCES DW.DIM_TAG
);
