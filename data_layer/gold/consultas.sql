...
SELECT 
    ...
    ROUND(QUALIDADE, 1) AS NOTA_MEDIA, 
    CASE 
        WHEN VOLUME <= 100 AND QUALIDADE >= 74 THEN 'Oceano Azul (Oportunidade)'

        WHEN VOLUME > 150 OR QUALIDADE < 71 THEN 'Oceano Vermelho (Saturado/Risco)'
